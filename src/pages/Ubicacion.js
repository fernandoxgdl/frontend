...
function Ubicacion(){
 return(
  <div style={{ 
   ...
   gap:'20px',}}>
   <h1>PROBLEMATICA</h1>
    <p>En la actualidad, el comercio electrónico ha experimentado un crecimiento significativo, pero muchas pequeñas empresas locales enfrentan desafíos para establecer una presencia en la web.🧑‍💻🛜 <br/> La falta de recursos técnicos y conocimientos digitales limita su capacidad para competir en el mercado digital.🤖</p>
   <p>Moda mx requiere una solución tecnológica que les permita crear y mantener una presencia en la web, lo que impulsara sus ventas, llevando así a un mayor impacto en el mercado.💳💰<br/>
   Los productores locales a menudo carecen de canales digitales 
